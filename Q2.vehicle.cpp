...
public:
    ...
    void setcompany_name(char* cnm)
    {
        strcpy(this->company_name, cnm);
    }

    void setmodel_no(int m)
    {
        this->model_no = m;
    }
    ...
    {
        cout << "disk and drum brakes are used in vehicle ";
    }
};
...
struct bike : public vehicle
{
    ...
    char* gethelmet_color()
    {
        return this->helmet_color;
    }
